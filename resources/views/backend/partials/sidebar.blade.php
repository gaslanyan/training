        ...
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
            ...
            <ul class="kt-menu__nav ">
                <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true">
                    <a href="{{action('Backend\AdminController@index')}}" class="kt-menu__link">
                ...
                <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"
                    ...
                    <a href="{{action('Backend\DashboardController@index')}}" class="kt-menu__link kt-menu__toggle">
                ...
                {{--                <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"--}}
                {{--                    data-ktmenu-submenu-toggle="hover">--}}
                {{--                    <a href="{{action('Backend\UserController@index')}}" class="kt-menu__link kt-menu__toggle">--}}
                {{--                        <span class="kt-menu__link-icon kt-demo-icon__preview">--}}
                {{--                           <i class="flaticon-users"></i>--}}
                {{--                        </span>--}}
                {{--                        <span class="kt-menu__link-text">Օգտագործողներ</span>--}}
                {{--                    </a>--}}
                {{--                </li>--}}
                {{--                <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true"--}}
                {{--                    data-ktmenu-submenu-toggle="hover">--}}
                {{--                    <a href="{{action('Backend\GroupController@index')}}" class="kt-menu__link kt-menu__toggle">--}}
                {{--                        <span class="kt-menu__link-icon kt-demo-icon__preview">--}}
                {{--                           <i class="flaticon2-avatar"></i>--}}
                {{--                        </span>--}}
                {{--                        <span class="kt-menu__link-text">Դերեր</span>--}}
                {{--                    </a>--}}
                {{--                </li>--}}
